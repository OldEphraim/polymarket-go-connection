...
type Querier interface {
	...
	DbSizePretty(ctx context.Context, dbname string) (string, error)
	...
	DropOldEmptyPartitions(ctx context.Context, arg DropOldEmptyPartitionsParams) (int32, error)
	...
	LastArchiveDoneEnd(ctx context.Context, tableName string) (sql.NullTime, error)
